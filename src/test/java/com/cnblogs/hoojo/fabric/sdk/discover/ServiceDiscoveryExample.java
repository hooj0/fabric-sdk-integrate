...
public class ServiceDiscoveryExample extends GoChaincodeIntegrationExamples {
    ...
    public void setup() throws Exception {
    	...
    	try {
            ...
            Organization org = getOrganization(ORG_NAME);
            User user = org.getUser(USER_NAME);
            ...
            Peer discoveryPeer = client.newPeer("peer0.org1.example.com", protocol + "//" + host + ":7051", peerProps);
            ...
            for (Orderer orderer : channel.getOrderers()) {
            	out("remove orderer: %s", orderer.getUrl());
